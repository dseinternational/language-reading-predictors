...
| `lrp-rli-ca-005` | `concurrent` | `R`     | per-wave conditional associations of concurrent skills with receptive vocabulary         |
| `lrp-rli-ca-006` | `concurrent` | `E`     | per-wave conditional associations of concurrent skills with expressive vocabulary        |
