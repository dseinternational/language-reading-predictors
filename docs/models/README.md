...
| `lrp-rli-mech-103`            | `TR → L` | Taught receptive vocabulary → letter sounds, lagged/predictive (#405; `TR_pre → L_post \| L_pre`, tests growth prediction; concurrent≫lagged is the "tracks but doesn't drive" signature)                            |
