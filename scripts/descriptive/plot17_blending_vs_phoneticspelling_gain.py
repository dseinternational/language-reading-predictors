...
"""Descriptive scatter: baseline blending vs phonetic spelling total gain.

x = blending (``blending``) level at time 1 (the fixed baseline).
y = phonetic spelling (``spphon``) total gain = level at the child's last available
...
Run::
    ...
    python scripts/descriptive/plot17_blending_vs_phoneticspelling_gain.py
"""
...
Y_COL = "spphon"  # outcome measure (level column)
X_LABEL = "baseline blending (phonological awareness)"
Y_LABEL = "phonetic spelling total gain (baseline to last wave)"
TITLE = "Baseline blending vs phonetic spelling gain"
OUT_NAME = "plot17_blending_vs_phoneticspelling_gain.png"
