...
"""Descriptive scatter: baseline blending vs nonword reading total gain.

x = blending (``blending``) level at time 1 (the fixed baseline).
y = nonword reading (``nonword``) total gain = level at the child's last available
...
Run::
    ...
    python scripts/descriptive/plot18_blending_vs_nonword_gain.py
"""
...
Y_COL = "nonword"  # outcome measure (level column)
X_LABEL = "baseline blending (phonological awareness)"
Y_LABEL = "nonword reading total gain (baseline to last wave)"
TITLE = "Baseline blending vs nonword reading gain"
OUT_NAME = "plot18_blending_vs_nonword_gain.png"
