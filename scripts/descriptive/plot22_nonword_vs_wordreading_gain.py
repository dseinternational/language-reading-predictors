...
"""Descriptive scatter: baseline nonword reading vs word reading total gain.

x = nonword reading (``nonword``) level at time 1 (the fixed baseline).
...
Run::
    ...
    python scripts/descriptive/plot22_nonword_vs_wordreading_gain.py
"""
...
TITLE = "Baseline nonword reading vs word reading gain"
OUT_NAME = "plot22_nonword_vs_wordreading_gain.png"
