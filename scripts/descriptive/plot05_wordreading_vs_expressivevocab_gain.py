...
"""Descriptive scatter: baseline word reading vs expressive vocabulary total gain.

x = word reading (``ewrswr``) level at time 1 (the fixed baseline).
...
Run::
    ...
    python scripts/descriptive/plot05_wordreading_vs_expressivevocab_gain.py
"""
...
X_COL = "ewrswr"  # predictor measure (level column)
Y_COL = "eowpvt"  # outcome measure (level column)
X_LABEL = "baseline word reading"
Y_LABEL = "expressive vocabulary total gain (baseline to last wave)"
TITLE = "Baseline word reading vs expressive vocabulary gain"
OUT_NAME = "plot05_wordreading_vs_expressivevocab_gain.png"
