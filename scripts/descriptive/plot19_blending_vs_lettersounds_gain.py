...
"""Descriptive scatter: baseline blending vs letter sounds total gain.

x = blending (``blending``) level at time 1 (the fixed baseline).
y = letter sounds (``yarclet``) total gain = level at the child's last available
...
Run::
    ...
    python scripts/descriptive/plot19_blending_vs_lettersounds_gain.py
"""
...
Y_COL = "yarclet"  # outcome measure (level column)
X_LABEL = "baseline blending (phonological awareness)"
Y_LABEL = "letter sounds total gain (baseline to last wave)"
TITLE = "Baseline blending vs letter sounds gain"
OUT_NAME = "plot19_blending_vs_lettersounds_gain.png"
