...
"""Descriptive scatter: baseline letter sounds vs expressive vocabulary total gain.

x = letter sounds (``yarclet``) level at time 1 (the fixed baseline).
...
Run::
    ...
    python scripts/descriptive/plot10_lettersounds_vs_expressivevocab_gain.py
"""
...
X_LABEL = "baseline letter sounds (YARC-LSK)"
Y_LABEL = "expressive vocabulary total gain (baseline to last wave)"
TITLE = "Baseline letter sounds vs expressive vocabulary gain"
OUT_NAME = "plot10_lettersounds_vs_expressivevocab_gain.png"
