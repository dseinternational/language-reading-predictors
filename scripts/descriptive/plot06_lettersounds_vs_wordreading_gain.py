...
"""Descriptive scatter: baseline letter sounds vs word reading total gain.
...
TITLE = "Baseline letter sounds vs word reading gain"
OUT_NAME = "plot06_lettersounds_vs_wordreading_gain.png"
