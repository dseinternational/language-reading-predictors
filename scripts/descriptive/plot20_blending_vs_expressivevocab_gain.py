...
"""Descriptive scatter: baseline blending vs expressive vocabulary total gain.

x = blending (``blending``) level at time 1 (the fixed baseline).
y = expressive vocabulary (``eowpvt``) total gain = level at the child's last available
...
Run::
    ...
    python scripts/descriptive/plot20_blending_vs_expressivevocab_gain.py
"""
...
X_COL = "blending"  # predictor measure (level column)
Y_COL = "eowpvt"  # outcome measure (level column)
X_LABEL = "baseline blending (phonological awareness)"
Y_LABEL = "expressive vocabulary total gain (baseline to last wave)"
TITLE = "Baseline blending vs expressive vocabulary gain"
OUT_NAME = "plot20_blending_vs_expressivevocab_gain.png"
