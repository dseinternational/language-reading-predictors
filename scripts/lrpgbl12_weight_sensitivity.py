...
"""
Sensitivity check: LRPGBL12 under inverse-frequency subject weighting.
...
1. Loads LRPGBL12's exact data, predictors, and MAE-tuned hyperparameters
...
5. Saves a side-by-side comparison of pooled OOF metrics and
   ...
   ``output/sensitivity/lrpgbl12_weight/``.
...
::
    ...
    python scripts/lrpgbl12_weight_sensitivity.py
"""
...
def main() -> None:
    ...
    ax.set_title("LRPGBL12 permutation importance — unweighted vs subject-weighted")
