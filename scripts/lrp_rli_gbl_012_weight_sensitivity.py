...
def _output_dir():
    return _paths.output_root() / "sensitivity" / "lrp-rli-gbl-012_weight"
...
def main() -> None:
    ...
    ax.set_title("LRP-RLI-GBL-012 permutation importance — unweighted vs subject-weighted")
