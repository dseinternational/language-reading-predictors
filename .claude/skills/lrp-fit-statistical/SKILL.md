...
| survival                    | `survival_summary.csv`                                             | Randomised-window available-case modified-ITT assignment contrast (at-floor subgroup) under complementary log-log; a hazard ratio is not a probability ratio, and no causal headline is released. |
