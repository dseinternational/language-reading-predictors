...
- **`aligned`** compares one intervention-aligned window per child, immediate t1→t3 and waitlist t2→t4. Age at onset and timing confound the cohort contrast. Every term is an association; dose enters only the sensitivity variant.
