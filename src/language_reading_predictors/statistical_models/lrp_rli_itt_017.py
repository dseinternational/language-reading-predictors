...
"""LRPITT17 - ability-adjusted available-case modified ITT estimate for taught receptive vocabulary (TR).
...
SPEC = ModelSpec(
    ...
    title=(
        ...
        "contrast in taught receptive vocabulary, block 1 (b1retau) (TR)"
    ),
    outcome_symbol="TR",
