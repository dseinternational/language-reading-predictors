...
"""LRPITT17 - general-ability-adjusted ITT for taught receptive vocabulary, block 1 (b1retau) (TR).

Ability-robustness companion to LRPITT01, part of the LRPITT17-24 ability-adjusted
...
Block design is complete for all 54 children, so no rows drop: LRPITT17 vs LRPITT01
...
SPEC = ModelSpec(
    model_id="lrp-rli-itt-017",
    kind="itt",
    title="Ability-adjusted ITT effect of group assignment on taught receptive vocabulary, block 1 (b1retau) (TR)",
    outcome_symbol="TR",
