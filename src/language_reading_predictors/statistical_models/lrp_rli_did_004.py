...
"""LRPDID04 - arm-by-wave contrasts for taught expressive vocabulary (TE).

The t1--t3 outcome levels are modelled with a saturated arm-by-wave structure.
``tau_t2`` is the clean randomised t2 contrast and is compared with LRPITT02.
...
SPEC = ModelSpec(
    ...
    kind="did",
    title="Waitlist-crossover arm-by-wave contrasts for taught expressive vocabulary, block 1 (b1extau) (TE)",
    outcome_symbol="TE",
    family="did",
