...
"""LRPLF205 - phonetic spelling (P), off-floor levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-005`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-205",
    kind="level_factors",
    title="Phonetic spelling (P), off-floor: randomised-window (t1/t2) comparator",
    outcome_symbol="P",
