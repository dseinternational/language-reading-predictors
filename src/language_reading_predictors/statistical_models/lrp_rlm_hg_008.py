...
"""RLMHG08 - historical BAS number-skills growth, waves 1-3 (Byrne et al., #164).

A descriptive group-by-wave growth model for BAS number skills (``basnum``) over
the first three waves of the Byrne, MacDonald & Buckley reading-language-memory
...
SPEC = ModelSpec(
    ...
    title="Historical BAS number-skills growth, waves 1-3 (Byrne et al.)",
