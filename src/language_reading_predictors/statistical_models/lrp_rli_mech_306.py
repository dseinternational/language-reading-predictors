...
"""LRP306 - composite-ability Tier-1 panel: letter sounds (L) -> nonword reading (N).

One-knob companion to **LRP196**, identical in rows, outcome, baseline,
...
**Read.** Against LRP196, not against the unadjusted LRP096. A slope that
...
association**. Role in the panel: the decoding-specific channel.
"""
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-306",
    kind="mechanism",
    title="Composite-ability Tier-1 panel: letter sounds (L) -> nonword reading (N)",
    outcome_symbol="N",
    mechanism_symbol="L",
