...
"""LRPLF209 - taught receptive vocabulary (TR) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-009`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-209",
    kind="level_factors",
    title="Taught receptive vocabulary (TR): randomised-window (t1/t2) comparator",
    outcome_symbol="TR",
