...
"""LRPITT20 - general-ability-adjusted ITT for not-taught expressive vocabulary, block 1 (b1exnt) (UE).

Ability-robustness companion to LRPITT04, part of the LRPITT17-24 ability-adjusted
...
Block design is complete for all 54 children, so no rows drop: LRPITT20 vs LRPITT04
...
SPEC = ModelSpec(
    model_id="lrp-rli-itt-020",
    kind="itt",
    title="Ability-adjusted ITT effect of group assignment on not-taught expressive vocabulary, block 1 (b1exnt) (UE)",
    outcome_symbol="UE",
