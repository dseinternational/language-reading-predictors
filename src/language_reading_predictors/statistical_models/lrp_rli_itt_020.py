...
"""LRPITT20 - ability-adjusted available-case modified ITT estimate for not-taught expressive vocabulary (UE).
...
SPEC = ModelSpec(
    ...
    title=(
        ...
        "contrast in not-taught expressive vocabulary, block 1 (b1exnt) (UE)"
    ),
    outcome_symbol="UE",
