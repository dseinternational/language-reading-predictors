...
"""LRP196 - ability-adjusted Tier-1 panel: letter sounds (L) -> nonword reading (N).

Ability-adjusted companion to LRP096. Identical in every respect except that the
...
controls (N among them for the control rows) should shrink towards zero here
...
positive control - the pure-decoding channel.
"""
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-196",
    kind="mechanism",
    title="Ability-adjusted Tier-1 panel: letter sounds (L) -> nonword reading (N)",
    outcome_symbol="N",
    mechanism_symbol="L",
