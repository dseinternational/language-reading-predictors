...
FAMILIES: dict[str, FamilyDescriptor] = {
    ...
    for descriptor in (
        ...
        _family(
            ...
            entry_points=("fit_did",),
            key_findings_builder="_kf_build_did",
        ),
        _family(
            "dose_response",
            "dose_response",
        ...
        _family(
            ...
            entry_points=("fit_itt",),
            key_findings_builder="_kf_build_itt",
        ),
        _family(
            "joint",
            "joint",
            ...
            entry_points=("fit_joint",),
            key_findings_builder="_kf_build_joint",
        ),
        _family(
            "joint_mechanism",
            "joint_mechanism",
        ...
        _family(
            ...
            entry_points=("fit_lcsm",),
            key_findings_builder="_kf_build_lcsm",
        ),
        _family(
            "level_factors",
            "level_factors",
            ...
            entry_points=("fit_level_factors",),
        ...
        _family(
            ...
            entry_points=("fit_pooled_levels",),
...
def descriptor_for(kind: str) -> FamilyDescriptor:
    ...
    try:
        ...
        raise KeyError(
            f"{kind!r} has no family descriptor; add it to family_registry.FAMILIES when the family is introduced"
        ) from None
