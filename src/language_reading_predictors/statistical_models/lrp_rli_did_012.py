...
"""LRPDID12 - arm-by-wave off-floor prevalence contrasts for nonword reading (N).
...
SPEC = ModelSpec(
    ...
    kind="did",
    title="Waitlist-crossover arm-by-wave off-floor prevalence contrasts for nonword reading (NWR) (N)",
    outcome_symbol="N",
    family="did",
