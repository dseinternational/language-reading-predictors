...
"""LRP201 - ability-adjusted Tier-1 panel: letter sounds (L) -> word reading (W).

Ability-adjusted companion to LRP101. Identical in every respect except that the
...
controls (W among them for the control rows) should shrink towards zero here
...
positive control - the mixed sight/decoding channel.
"""
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-201",
    kind="mechanism",
    title="Ability-adjusted Tier-1 panel: letter sounds (L) -> word reading (W)",
    outcome_symbol="W",
    mechanism_symbol="L",
