...
"""LRP200 - ability-adjusted Tier-1 panel: letter sounds (L) -> basic concepts (F).

Ability-adjusted companion to LRP100. Identical in every respect except that the
...
controls (F among them for the control rows) should shrink towards zero here
...
negative control - the weakest oral-language control (18 items).
"""
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-200",
    kind="mechanism",
    title="Ability-adjusted Tier-1 panel: letter sounds (L) -> basic concepts (F)",
    outcome_symbol="F",
    mechanism_symbol="L",
