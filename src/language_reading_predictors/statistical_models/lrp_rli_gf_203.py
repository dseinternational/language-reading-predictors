...
"""LRPGF03m - treatment-moderation variant of LRPGF03 (expressive vocabulary (E)).

Explicitly associational moderation companion (#391 finding 3 decision, 2026-07-22):
identical to LRPGF03 except that it retains the pre-specified treatment
...
is a causal headline — read the randomised effect from LRPGF03 — and the fit
...
SPEC = ModelSpec(
    model_id="lrp-rli-gf-203",
    kind="gain_factors",
    title="Treatment-moderation variant: gains in expressive vocabulary (E)",
    outcome_symbol="E",
    extra={
