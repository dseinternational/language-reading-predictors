...
associational variant LRPGF03m, and only the age x ability precision interaction
remains here.
"""
...
SPEC = ModelSpec(
    model_id="lrp-rli-gf-003",
    kind="gain_factors",
    title="Factors associated with gains in expressive vocabulary (E)",
    outcome_symbol="E",
