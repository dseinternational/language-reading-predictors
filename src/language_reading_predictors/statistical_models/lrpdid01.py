...
"""LRPDID01 - waitlist-crossover / difference-in-differences ITT effect on word reading (EWRSWR) (W).
...
DiD). Compare delta against the single-outcome RCT tau (LRPITT10).
...
SPEC = ModelSpec(
    model_id="lrpdid01",
    kind="did",
    title="Waitlist-crossover (DiD) ITT effect of the intervention on word reading (EWRSWR) (W)",
    outcome_symbol="W",
    extra={
        "outcomes": ("W",),
        "periods": (0, 1),
