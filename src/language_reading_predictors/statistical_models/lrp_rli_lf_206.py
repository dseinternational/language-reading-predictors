...
"""LRPLF206 - phoneme blending (blending) (B) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-006`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    ...
    kind="level_factors",
    title="Phoneme blending (blending) (B): randomised-window (t1/t2) comparator",
    outcome_symbol="B",
