...
"""LRPLF204 - letter sounds (L) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-004`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-204",
    kind="level_factors",
    title="Letter sounds (L): randomised-window (t1/t2) comparator",
    outcome_symbol="L",
