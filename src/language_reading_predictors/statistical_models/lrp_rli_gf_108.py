...
2026-07-10 DAG, ``dag/dag-language-reading.dagitty``, #247). The LRPGF08 model
restricted to on-intervention period rows (excluding the waitlist arm's untreated
period 1). Associations with how much children gain in receptive grammar (RG, TROG)
across the period transitions (ANCOVA, Beta-Binomial logit, child random intercept).

Under the revised DAG the parents of RG are age, general ability, receptive vocabulary
...
(``skill_symbols``) and no extra confounders (``adjust_for`` empty: RG has no
