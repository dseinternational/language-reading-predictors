...
"""LRPAL08 - aligned-40-week per-protocol single gain for receptive grammar (T).
...
SPEC = ModelSpec(
    model_id="lrp-rli-al-008",
    kind="aligned",
    title="Aligned-40-week per-protocol gain for receptive grammar (T)",
    outcome_symbol="T",
    extra={
