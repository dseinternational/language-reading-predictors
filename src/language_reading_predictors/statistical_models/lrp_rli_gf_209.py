...
"""LRPGF09m - treatment-moderation variant of LRPGF09 (taught receptive vocabulary (TR)).

Explicitly associational moderation companion (#391 finding 3 decision, 2026-07-22):
identical to LRPGF09 except that it retains the pre-specified treatment
...
is a causal headline — read the randomised effect from LRPGF09 — and the fit
...
SPEC = ModelSpec(
    model_id="lrp-rli-gf-209",
    kind="gain_factors",
    title="Treatment-moderation variant: gains in taught receptive vocabulary (TR)",
    outcome_symbol="TR",
