...
"""LRPLF207 - CELF basic concepts (F) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-007`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-207",
    kind="level_factors",
    title="CELF basic concepts (F): randomised-window (t1/t2) comparator",
    outcome_symbol="F",
