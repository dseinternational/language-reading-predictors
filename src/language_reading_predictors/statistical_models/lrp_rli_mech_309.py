...
"""LRP309 - composite-ability Tier-1 panel: letter sounds (L) -> receptive grammar (T).

One-knob companion to **LRP199**, identical in rows, outcome, baseline,
...
**Read.** Against LRP199, not against the unadjusted LRP099. A slope that
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-309",
    kind="mechanism",
    title="Composite-ability Tier-1 panel: letter sounds (L) -> receptive grammar (T)",
    outcome_symbol="T",
    mechanism_symbol="L",
