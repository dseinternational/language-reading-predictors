...
"""LRPGF02m - treatment-moderation variant of LRPGF02 (receptive vocabulary (R)).

Explicitly associational moderation companion (#391 finding 3 decision, 2026-07-22):
identical to LRPGF02 except that it retains the pre-specified treatment
...
is a causal headline — read the randomised effect from LRPGF02 — and the fit
...
SPEC = ModelSpec(
    model_id="lrp-rli-gf-202",
    kind="gain_factors",
    title="Treatment-moderation variant: gains in receptive vocabulary (R)",
    outcome_symbol="R",
    extra={
        "skill_symbols": ('TR',),
