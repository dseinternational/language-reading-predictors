...
"""RLMHG07 - historical BAS similarities growth, waves 1-3 (Byrne et al., #164).

A descriptive group-by-wave growth model for BAS similarities / verbal reasoning
(``bassim``) over the first three waves of the Byrne, MacDonald & Buckley
...
SPEC = ModelSpec(
    ...
    title="Historical BAS similarities growth, waves 1-3 (Byrne et al.)",
