...
"""LRPITT19 - ability-adjusted available-case modified ITT estimate for not-taught receptive vocabulary (UR).
...
SPEC = ModelSpec(
    ...
    title=(
        ...
        "contrast in not-taught receptive vocabulary, block 1 (b1rent) (UR)"
    ),
    outcome_symbol="UR",
