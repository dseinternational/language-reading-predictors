...
"""LRPLF203 - expressive vocabulary (E) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-003`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-203",
    kind="level_factors",
    title="Expressive vocabulary (E): randomised-window (t1/t2) comparator",
    outcome_symbol="E",
