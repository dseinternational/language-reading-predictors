...
"""RLMHG06 - historical BAS recall-of-digits growth, waves 1-3 (Byrne et al., #164).

A descriptive group-by-wave growth model for BAS recall of digits (``basdig``, a
verbal short-term / phonological-memory measure) over the first three waves of
...
**Provisional ceiling.** The Beta-Binomial denominator (``n_trials=34``) is the
...
SPEC = ModelSpec(
    ...
    title="Historical BAS recall-of-digits growth, waves 1-3 (Byrne et al.)",
