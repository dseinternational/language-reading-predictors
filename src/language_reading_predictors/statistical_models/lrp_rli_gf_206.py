...
"""LRPGF06m - treatment-moderation variant of LRPGF06 (phoneme blending (blending) (B)).

Explicitly associational moderation companion (#391 finding 3 decision, 2026-07-22):
identical to LRPGF06 except that it retains the pre-specified treatment
...
is a causal headline — read the randomised effect from LRPGF06 — and the fit
...
SPEC = ModelSpec(
    ...
    kind="gain_factors",
    title="Treatment-moderation variant: gains in phoneme blending (blending) (B)",
    outcome_symbol="B",
