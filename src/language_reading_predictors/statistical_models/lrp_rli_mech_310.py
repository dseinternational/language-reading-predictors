...
"""LRP310 - composite-ability Tier-1 panel: letter sounds (L) -> basic concepts (F).

One-knob companion to **LRP200**, identical in rows, outcome, baseline,
...
**Read.** Against LRP200, not against the unadjusted LRP100. A slope that
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-310",
    kind="mechanism",
    title="Composite-ability Tier-1 panel: letter sounds (L) -> basic concepts (F)",
    outcome_symbol="F",
    mechanism_symbol="L",
