...
"""LRP199 - ability-adjusted Tier-1 panel: letter sounds (L) -> receptive grammar (T).

Ability-adjusted companion to LRP099. Identical in every respect except that the
...
controls (T among them for the control rows) should shrink towards zero here
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-199",
    kind="mechanism",
    title="Ability-adjusted Tier-1 panel: letter sounds (L) -> receptive grammar (T)",
    outcome_symbol="T",
    mechanism_symbol="L",
