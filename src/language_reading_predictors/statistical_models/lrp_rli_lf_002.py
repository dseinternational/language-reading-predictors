...
"""LRPLF02 - level factors for receptive vocabulary (R).

DAG-focused level-factors model (#127): associations with the receptive vocabulary score
...
very trajectory the model estimates. The t2 arm contrast compares treatment with no treatment yet. Later arm
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-002",
    kind="level_factors",
    title="Factors associated with the level of receptive vocabulary (R)",
    outcome_symbol="R",
