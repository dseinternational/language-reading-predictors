...
companions and LRPDID01-LRPDID13 are the waitlist-crossover arm-by-wave family
(including observational dose companions). LRP56-LRP58 and LRP71-LRP73 are mechanism
...
``lrp-rli-itt-024`` companions, the ``lrp-rli-did-001`` ... ``lrp-rli-did-013`` crossover family,
