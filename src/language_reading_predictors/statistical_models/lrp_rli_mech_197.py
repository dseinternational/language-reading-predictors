...
"""LRP197 - ability-adjusted Tier-1 panel: letter sounds (L) -> receptive vocabulary (R).

Ability-adjusted companion to LRP097. Identical in every respect except that the
...
controls (R among them for the control rows) should shrink towards zero here
...
SPEC = ModelSpec(
    model_id="lrp-rli-mech-197",
    kind="mechanism",
    title="Ability-adjusted Tier-1 panel: letter sounds (L) -> receptive vocabulary (R)",
    outcome_symbol="R",
    mechanism_symbol="L",
