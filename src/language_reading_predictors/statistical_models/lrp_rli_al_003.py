...
"""LRPAL03 - aligned-40-week per-protocol single gain for expressive vocabulary (E).
...
SPEC = ModelSpec(
    model_id="lrp-rli-al-003",
    kind="aligned",
    title="Aligned-40-week per-protocol gain for expressive vocabulary (E)",
    outcome_symbol="E",
    extra={
