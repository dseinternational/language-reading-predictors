...
"""LRPGF11m - treatment-moderation variant of LRPGF11 (nonword reading (N), off-floor).

Explicitly associational moderation companion (#391 finding 3 decision, 2026-07-22):
identical to LRPGF11 except that it retains the pre-specified treatment
...
is a causal headline — read the randomised effect from LRPGF11 — and the fit
...
SPEC = ModelSpec(
    model_id="lrp-rli-gf-211",
    kind="gain_factors",
    title="Treatment-moderation variant: gains in nonword reading (N), off-floor",
    outcome_symbol="N",
