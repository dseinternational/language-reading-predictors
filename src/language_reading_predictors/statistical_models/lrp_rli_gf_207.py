...
"""LRPGF07m - treatment-moderation variant of LRPGF07 (CELF basic concepts (F)).

Explicitly associational moderation companion (#391 finding 3 decision, 2026-07-22):
identical to LRPGF07 except that it retains the pre-specified treatment
...
is a causal headline — read the randomised effect from LRPGF07 — and the fit
...
SPEC = ModelSpec(
    model_id="lrp-rli-gf-207",
    kind="gain_factors",
    title="Treatment-moderation variant: gains in CELF basic concepts (F)",
    outcome_symbol="F",
