...
"""LRPLF211 - nonword reading (N), off-floor levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-011`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-211",
    kind="level_factors",
    title="Nonword reading (N), off-floor: randomised-window (t1/t2) comparator",
    outcome_symbol="N",
