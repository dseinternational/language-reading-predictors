...
"""LRPLF202 - receptive vocabulary (R) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-002`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-202",
    kind="level_factors",
    title="Receptive vocabulary (R): randomised-window (t1/t2) comparator",
    outcome_symbol="R",
