...
"""RLMHG04 - historical BPVS receptive-vocabulary growth, waves 1-3 (Byrne et al., #164).

A descriptive group-by-wave growth model for BPVS receptive vocabulary (``bpvs``)
...
**Provisional ceiling.** The Beta-Binomial denominator (``n_trials=29``) is the
...
SPEC = ModelSpec(
    model_id="lrp-rlm-hg-004",
    kind="historical_growth",
    title="Historical BPVS receptive-vocabulary growth, waves 1-3 (Byrne et al.)",
    outcome_symbol="bpvs",
    study_id="rlm",
