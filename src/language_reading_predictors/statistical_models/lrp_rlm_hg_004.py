...
"""RLMHG04 - historical BPVS receptive-vocabulary growth, waves 1-4 + DS wave 5 (Byrne et al., #164/#338).
...
SPEC = ModelSpec(
    ...
    title="Historical BPVS receptive-vocabulary growth, waves 1-4 + DS wave 5 (Byrne et al.)",
    outcome_symbol="bpvs",
    study_id="rlm",
