...
"""LRPLF208 - TROG receptive grammar (T) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-008`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-208",
    kind="level_factors",
    title="TROG receptive grammar (T): randomised-window (t1/t2) comparator",
    outcome_symbol="T",
