...
"""LRP311 - composite-ability Tier-1 panel: letter sounds (L) -> word reading (W).

One-knob companion to **LRP201**, identical in rows, outcome, baseline,
...
**Read.** Against LRP201, not against the unadjusted LRP101. A slope that
...
association**. Role in the panel: the mixed sight/decoding channel.
"""
...
SPEC = ModelSpec(
    ...
    kind="mechanism",
    title="Composite-ability Tier-1 panel: letter sounds (L) -> word reading (W)",
    outcome_symbol="W",
    mechanism_symbol="L",
