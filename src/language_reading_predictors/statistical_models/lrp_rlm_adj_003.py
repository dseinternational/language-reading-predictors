...
"""RLMADJ03 - confirmed-input predictors of receptive-vocabulary gain (#409 D1).

This wider-outcome companion asks how wave-1 BAS word reading (``basread``),
receptive grammar (``trog``), verbal memory (``basdig``), verbal reasoning
(``bassim``) and age are associated with wave-1 to wave-3 BPVS receptive-
vocabulary gain after mutual adjustment and conditioning on wave-1 BPVS. All
five measurement inputs have confirmed instrument identities and ceilings.
