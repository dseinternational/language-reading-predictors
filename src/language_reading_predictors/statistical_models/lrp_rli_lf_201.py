...
"""LRPLF201 - word reading (W) levels, randomised-window (t1/t2) comparator.

The registered comparator to ``lrp-rli-lf-001`` (#584 decision 3). Identical
...
SPEC = ModelSpec(
    model_id="lrp-rli-lf-201",
    kind="level_factors",
    title="Word reading (W): randomised-window (t1/t2) comparator",
    outcome_symbol="W",
