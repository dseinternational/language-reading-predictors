...
class LRPGBL07NoConstruct(LRPGBL07):
    ...
    notes = (
        "Same-skill variant of lrpgbl07: drops aptgram (APT grammar, scored from the same picture descriptions as aptinfo) to ask what predicts expressive information beyond a parallel scoring of the same test. Receptive grammar (trog) and other constructs kept visible. Re-tuned on the reduced set. See notes/202606210930-lrp-same-skill-variants.md."
    )
