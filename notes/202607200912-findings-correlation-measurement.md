...
The concurrent and adjusted models sharpen _which_ skills sit together: **letter-sound knowledge is the strongest concurrent partner of word reading**, the code cluster (letter-sounds + blending + word reading) coheres somewhat apart from the vocabulary cluster (broad + taught vocabulary co-moving), and **between children, younger age and better hearing are the clearest correlates of word-reading gain** — the hearing link surviving SES adjustment.
