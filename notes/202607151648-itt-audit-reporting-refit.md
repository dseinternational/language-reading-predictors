...
- The published trial randomised 57 children, 29 immediate and 28 wait-list, while the repository contains 54. The models produce **available-case modified ITT estimates**, not full-randomised-cohort ITT estimates; extending estimates to the missing children requires an untestable missingness assumption or recovered data. Trial counts are documented by Burgoyne et al. (2012), DOI [10.1111/j.1469-7610.2012.02557.x](https://doi.org/10.1111/j.1469-7610.2012.02557.x).
