...
3. Describe MAE predictions as estimates of conditional medians. Describe Huber predictions as fitted Huber location estimates; they need not equal conditional means. Partial-dependence and SHAP plots describe the fitted model, with its approximation and estimation error.
