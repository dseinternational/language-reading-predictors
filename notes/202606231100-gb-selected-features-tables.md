...
- **Near-miss** = a predictor that cleared the importance noise floor in the
  _full_ predictor set (full-set out-of-fold permutation-importance mean > 0.005)
...
In other words, nearly every near-miss carries _the same construct_ as a retained
