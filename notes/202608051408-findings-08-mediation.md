...
The letter-sound route also carries the intervention's effect on **coming off the floor in nonword reading** (an 8.7 percentage-point indirect effect, very strong evidence, with the direct effect at −0.01 — again essentially all indirect). For phoneme blending the route is moderate at best.
...
Taken with note 07, the mechanism picture is: the intervention raises letter-sound knowledge; letter-sound knowledge carries essentially the whole word-reading gain and the whole off-the-floor nonword-reading gain; no vocabulary or blending route competes with it; a grammar negative control correctly shows nothing; and the reverse ordering, while smaller, is not excluded.
