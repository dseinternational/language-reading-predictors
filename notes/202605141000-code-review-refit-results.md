...
For models where the top-3 set is unchanged (LRP02, LRP06, LRP08, LRP16, LRP19, LRP20), no construct-level narrative needs updating. For the rest, the _families_ in play are the same — the relative weight has shifted.
...
Models where the top-1 _stability_ feature changed:
