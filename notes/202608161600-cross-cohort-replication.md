...
The Byrne analysis extract still contains 97 participants while the separate raw export contains 96. The chosen instrument identities and ceilings are confirmed, but source lineage is not. Every generated table and figure therefore carries `comparison_publication_ready = false`, the source-file digest and the blocker text. These artefacts are diagnostic until the 96-versus-97 discrepancy is reconciled.
