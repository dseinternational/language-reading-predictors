...
These are the pieces most relevant to word reading. **Latent code is a positive adjusted association with word reading (WR)**, strongest in the errors-in-variables model:
